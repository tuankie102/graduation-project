import { IBackendRes, ICompany, IAccount, IUser, IModelPaginate, IGetAccount, IJob, IResume, IPermission, IRole, ISkill, ISubscribers, IPost } from '@/types/backend';
...
Module Resume
 */
export const callCreateResume = (url: string, postId: any, email: string, userId: string | number) => {
...
export const callUpdatePost = (post: IPost, id: string) => {
    return axios.put<IBackendRes<IPost>>(`/api/v1/posts`, { id, ...post })
}
