...
import { EnvironmentOutlined, ThunderboltOutlined, UserOutlined } from '@ant-design/icons';
                                    ...
                                    >
                                        <div className={styles["card-job-content"]}>
                                            ...
                                            <div className={styles["card-job-right"]}>
                                                ...
                                                <div className={styles["job-updatedAt"]}>{item.createdAt ? dayjs(item.createdAt).locale('en').fromNow() : dayjs(item.createdAt).locale('en').fromNow()}</div>
                                                <br />
                                                <div className={styles["job-updatedAt"]}>
                                                    <UserOutlined />&nbsp;{item.job?.user?.name || "Unknown"}
                                                </div>
                                            </div>
                                        </div>
